...
namespace Prototipo__RRHH
{
    public partial class Comision_marca : Form
    {
        ...
        public void factura()
        {
            ...
            Conexion.Open();
            Query.CommandText = "SELECT id_fac_empresa_pk,total From factura where id_empleados_pk = '" + selectedItem2 + "'And id_empresa_pk ='" + selectedItem + "' AND fecha_emision BETWEEN '"+date1+"' AND '"+date2+"';";
            ...
            for (int fila = 0; fila < dataGridView1.RowCount; fila++)
            {
                ...
                while (consultar.Read())
                {
                    if (cont1 == 0)
                    {
                        ...
                        dataGridView1.Rows[0].Cells[8].Value = marca_desc;
                        //MessageBox.Show(Convert.ToString(precio_pro));
                        dataGridView1.Rows[0].Cells[9].Value = porc_mar;
                    ...
                    else
                    {
                        ...
                        porc_mar = consultar.GetDecimal(1);
                        //proce_pro = consultar.GetDecimal(1);
                        dataGridView1.Rows[cont1].Cells[8].Value = marca_desc;
                        //MessageBox.Show(Convert.ToString(precio_pro));
                        dataGridView1.Rows[cont1].Cells[9].Value = porc_mar;
        ...
        public void comision()
        {
            ...
            for (int fila = 0; fila < dataGridView1.RowCount - 1; fila++)
            {
                ...
                dataGridView1.Rows[fila].Cells[11].Value = total_comision;
            }
        ...
        public void totales()
        {
            ...
            for (int fila = 0; fila < dataGridView1.RowCount - 1; fila++)
            {
                ...
                dataGridView1.Rows[fila].Cells[10].Value = total_venta;
            }
