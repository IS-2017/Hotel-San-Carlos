...
{
    public partial class comisiones_producto : Form
    {
        public comisiones_producto()
        {
            InitializeComponent();
        }
        ...
        private void comisiones_producto_Load(object sender, EventArgs e)
        {
        ...
        private void llenarvendedor()
        {
            ...
            DataSet ds = new DataSet();
            //se indica la consulta en sql=
            String Query = "select id_empleados_pk, nombre from empleado where id_empresa_pk ='" + selectedItem + "' AND cargo = 'VENDEDOR' AND estado <>'INACTIVO'";
            OdbcDataAdapter dad = new OdbcDataAdapter(Query, Conexionmysql.ObtenerConexion());
            //se indica con quu tabla se llena
            ...
            for (int fila = 0; fila < dataGridView1.RowCount; fila++)
            {
                ...
                while (consultar.Read())
                {
                    if (cont1 == 0)
                    {
                        ...
                        dataGridView1.Rows[0].Cells[7].Value = proce_pro;
                    ...
                    else
                    {
                        ...
                        //MessageBox.Show(Convert.ToString(precio_pro));
                        dataGridView1.Rows[cont1].Cells[7].Value = proce_pro;
        ...
        public void comision()
        {
            ...
            for (int fila = 0; fila < dataGridView1.RowCount - 1; fila++)
            {
                ...
                dataGridView1.Rows[fila].Cells[9].Value = total_comision;
            }
        ...
        public void totales()
        {
            ...
            for (int fila = 0; fila < dataGridView1.RowCount - 1; fila++)
            {
                ...
                dataGridView1.Rows[fila].Cells[8].Value = total_venta;
            }
