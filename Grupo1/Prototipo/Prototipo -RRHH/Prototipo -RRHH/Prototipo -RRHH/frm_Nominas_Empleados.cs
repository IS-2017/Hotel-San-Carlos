...
namespace Prototipo__RRHH
{
    public partial class frm_Nominas_Empleados : Form
    {
        ...
        public frm_Nominas_Empleados(DataGridView dgv, String id_nomina_pk, String nombre_nomina, String fecha_inicio_pago, String fecha_de_corte, String id_empresa_pk, String estado, Boolean Editar1, Boolean tipo_accion, ComboBox cbo_lista_nom)
        {
            this.dg = dgv;
            this.cb = cbo_lista_nom;
            this.Editar = Editar1;
            InitializeComponent();
        ...
        {
            string tabla = "nomina";
            fn.ActualizarGrid(this.dg, "Select id_nomina_pk, nombre_nomina, fecha_inicio_pago, fecha_de_corte, id_empresa_pk, estado from nomina WHERE estado <> 'INACTIVO' and id_empresa_pk = '" + this.cb.SelectedValue + "' ", tabla);
        }
