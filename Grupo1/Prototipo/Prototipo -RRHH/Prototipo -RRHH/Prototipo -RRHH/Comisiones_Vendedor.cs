...
namespace Prototipo__RRHH
{
    public partial class Comisiones_Vendedor : Form
    {
        ...
        int id;
        decimal total;
        private static string id_form = "13202";
        ...
        public void totales()
        {
            ...
            for (int fila = 0; fila < dataGridView1.RowCount - 1; fila++)
            {
                ...
                Math.Round(total_comi, 2);
                Math.Round(total_venta, 2);
            }
        ...
        private void cbo_empleado_SelectedIndexChanged_1(object sender, EventArgs e)
        {
            dataGridView1.Rows.Clear();
            dataGridView1.Refresh();
            txt_total_com.Text = "";
