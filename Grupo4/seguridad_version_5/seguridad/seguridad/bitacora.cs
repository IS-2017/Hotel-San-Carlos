    ...
    public class bitacora
    {
        ...
        public DataTable ObtenerOperaciones()
        {
            try
            {
                ...
                OdbcCommand cmd = new OdbcCommand("select distinct descripcion from bitacora order by (fecha and hora) DESC", con);
            ...
            catch
            {
                ...
                ErrorOp("Acceso denegado a usuario: " + Conexion.User, "bitacora");
                return null;
            }
        }
        public DataTable ObtenerTablas()
        {
            try
            {
                OdbcConnection con = Conexion.ObtenerConexionODBC();
                DataTable dt = new DataTable();
                OdbcCommand cmd = new OdbcCommand("select distinct tabla from bitacora order by (fecha and hora) DESC", con);
                OdbcDataAdapter adp = new OdbcDataAdapter(cmd);
                adp.Fill(dt);
                con.Close();
                return dt;
