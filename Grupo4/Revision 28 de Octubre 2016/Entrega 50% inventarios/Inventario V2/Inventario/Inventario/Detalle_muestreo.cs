    ...
    public partial class Detalle_muestreo : Form
    {
        ...
        private void btn_guardar_Click(object sender, EventArgs e)
        {
            ...
            if (!String.IsNullOrEmpty(txt_descripcion.Text.Trim() + txt_existencias.Text))
            {
                ...
                int x = sd.Agregar_detalle_muestreo(txt_ident.Text, txt_descripcion.Text, "0", cbo_bien.SelectedValue.ToString(), cbo_bodega.SelectedValue.ToString(), cbo_categoria.SelectedValue.ToString(), txt_existencias.Text);
                if (textBox1.Text == "e")
                {
                    //   MessageBox.Show("");
                    SistemaInventarioDatos ds = new SistemaInventarioDatos();
