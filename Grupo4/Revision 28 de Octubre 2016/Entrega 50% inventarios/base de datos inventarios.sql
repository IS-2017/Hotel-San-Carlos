...
INSERT INTO `bien` VALUES (1,'AF',0,865,'microondas oster',1,0,NULL,NULL,NULL,3,'activo',1),(1,'MP',0,15,'salsa de tomate naturas',4,0,NULL,NULL,NULL,3,'activo',3),(2,'AF',0,680,'Televisor',1,0,NULL,NULL,NULL,3,'activo',7),(2,'MP',0,5,'Consome de pollo',5,0,NULL,NULL,NULL,3,'activo',9);
...
CREATE TABLE `bitacora` (
  ...
  PRIMARY KEY (`id_bit`)
) ENGINE=InnoDB AUTO_INCREMENT=16369 DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `bodega` VALUES (2,'central','bodega principal',NULL,'activo',1),(3,'central','bodega 2',NULL,'activo',1),(4,'central','bodega 3',NULL,'activo',1);
...
INSERT INTO `categoria` VALUES ('AF','Activos fijos','activo'),('MP','Materia prima','activo'),('PT','Producto terminado','activo');
...
CREATE TABLE `compra` (
  ...
  `id_factura_pk` int(11) DEFAULT NULL,
...
INSERT INTO `compra` VALUES (1,NULL,1,'A',NULL,NULL,NULL,'activo',NULL,NULL,NULL);
...
INSERT INTO `detalle_compra` VALUES (1,8,NULL,NULL,'activo',1,2,'MP');
...
INSERT INTO `detalle_requisicion` VALUES (17,7,'activo',1,'MP',18),(18,5,'activo',2,'MP',18),(19,1,'activo',1,'AF',18),(20,1,'activo',2,'AF',19),(21,1,'activo',1,'AF',19);
...
INSERT INTO `encabezado_muestreo` VALUES (3,'2016-10-27','jose luis','activo');
...
INSERT INTO `linea` VALUES (1,'electronicos','AF','activo'),(2,'vehiculos','AF','activo'),(3,'lacteos','MP','activo'),(4,'Salsas','MP','activo'),(5,'condimentos','MP','activo');
...
INSERT INTO `marca` VALUES (1,'Pepsi','activo'),(2,'Coca-cola','activo'),(3,'Naturas','activo'),(4,'Ketchup','activo'),(5,'Colgate','activo'),(6,'Oster','activo'),(7,'Samsung','activo'),(8,'Toyota','activo'),(9,'Maller','activo'),(10,'toshiba','activo');
...
INSERT INTO `producto_bodega` VALUES (1,0,'AF',0,NULL,NULL,'activo'),(1,0,'art',0,NULL,NULL,'activo'),(1,0,'MP',0,NULL,NULL,'activo'),(1,1,'Refr',5,NULL,NULL,NULL),(1,1,'Sal',8,NULL,NULL,NULL),(1,2,'AF',0,0,45,NULL),(1,2,'PT',0,0,344,NULL),(1,2,'Refr',5,NULL,NULL,NULL),(1,2,'Sal',3,NULL,NULL,NULL),(2,0,'AF',0,NULL,NULL,'activo'),(2,0,'MP',0,NULL,NULL,'activo');
...
INSERT INTO `requisicion` VALUES (18,'2016-10-27','Jose Luis','activo',2),(19,'2016-10-27','Jorge','activo',2);
...
-- Dump completed on 2016-10-28  0:04:13
