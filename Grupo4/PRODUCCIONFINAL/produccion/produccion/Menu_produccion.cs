...
namespace produccion
{
    public partial class Menu_produccion : Form
    {
        ...
        modifica_pedido nfmodped = new modifica_pedido();
        ...
        frm_menu_nuevo menu_nuevo = new frm_menu_nuevo();
        menu_seguridad menseg = new menu_seguridad();
        ...
        private void crearToolStripMenuItem_Click(object sender, EventArgs e)
        {
            if (menu_nuevo == null)
            {
                menu_nuevo = new frm_menu_nuevo();
                menu_nuevo.MdiParent = this;
                menu_nuevo.FormClosed += new FormClosedEventHandler(frm_menu_nuevo_FormClosed);
                menu_nuevo.StartPosition = FormStartPosition.CenterParent;
                menu_nuevo.Show();
            }
        }

        private void frm_menu_nuevo_FormClosed(object sender, FormClosedEventArgs e)
        {
            menu_nuevo = null;
        }
        ...
        private void gestionarToolStripMenuItem_Click(object sender, EventArgs e)
        {
            if (nfmodped == null)
            {
                nfmodped = new modifica_pedido();
                nfmodped.MdiParent = this;
                nfmodped.FormClosed += new FormClosedEventHandler(modifica_pedido_FormClosed);
                nfmodped.StartPosition = FormStartPosition.CenterParent;
                nfmodped.Show();
            }
        }

        private void modifica_pedido_FormClosed(object sender, FormClosedEventArgs e)
        {
            nfmodped = null;
        }
        ...
        private void menúToolStripMenuItem_Click(object sender, EventArgs e)
        {
            if (menseg == null)
            {
                menseg = new menu_seguridad();
                //menseg.MdiParent = this;
                menseg.FormClosed += new FormClosedEventHandler(menu_seguridad_FormClosed);
                menseg.StartPosition = FormStartPosition.CenterParent;
                menseg.Show();
            }
        }

        private void menu_seguridad_FormClosed(object sender, FormClosedEventArgs e)
        {
            menseg = null;
        }
        ...
        {
            string pdfPath = Path.Combine(Application.StartupPath, "manualtecnico.pdf");
