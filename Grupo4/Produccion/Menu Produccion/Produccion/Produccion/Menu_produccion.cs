    ...
    public partial class Menu_produccion : Form
    {
        ...
        private void visualizarToolStripMenuItem_Click(object sender, EventArgs e)
        {
            if (nfmen == null)
            {
                ...
                nfmen.FormClosed += new FormClosedEventHandler(frm_modificar_recetario_FormClosed);
        ...
        {
            if (nmfrecetario == null)
            {
                nmfrecetario = new frm_modificar_recetario();
                nmfrecetario.MdiParent = this;
                nmfrecetario.FormClosed += new FormClosedEventHandler(frm_modificar_recetario_FormClosed);
                nmfrecetario.StartPosition = FormStartPosition.CenterParent;
                nmfrecetario.Show();
            }
        }
