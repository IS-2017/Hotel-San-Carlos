...
namespace cuentas_corrientes
{
    public partial class frmDataImpuesto : Form
    {
        public frmDataImpuesto()
        {
            ...
            OdbcDataAdapter dausuario = new OdbcDataAdapter("SELECT id_impuesto_pk, nombre, porcentaje, descripcion FROM impuesto where estado='activo'", conexion);
      ...
      public   clsimpuesto ImpSelec { get; set; }
        ...
        private void btn_buscar_Click(object sender, EventArgs e)
        {
            ...
            op.ejecutar(dgv_impuesto, "impuesto");
        }
        ...
        private void dgv_impuesto_CellClick(object sender, DataGridViewCellEventArgs e)
        {
