...
namespace cuentas_corrientes
{
    public partial class Devoluciones : Form
    {
        public Devoluciones()
        {
            ...
            OdbcDataAdapter dausuario = new OdbcDataAdapter("SELECT devolucion_venta.id_dev, empresa.nombre, devolucion_venta.id_fact_emp, devolucion_venta.serie, cliente.nombre, cliente.apellido, devolucion_venta.fecha, devolucion_venta.motivo, devolucion_venta.total from empresa, devolucion_venta, cliente where empresa.id_empresa_pk=devolucion_venta.id_empresa and cliente.id_cliente_pk=devolucion_venta.id_cliente and devolucion_venta.estado='activo'", conexion);
        ...
        public ClsDevo DevSelec { get; set; }
    ...
    *frmDevolucion temp = new frmDevolucion(fact);
        ...
        {
            if (dgv_dev.SelectedRows.Count == 1)
            {
                int id = Convert.ToInt16(dgv_dev.CurrentRow.Cells[0].Value);
                DevSelec =ClsOpFact.ObtenerDev(id);
                cuentas_corrientes.frmDevolucion impe = new cuentas_corrientes.frmDevolucion(DevSelec);
                impe.ShowDialog();

            }
            else
            {
                frmDevolucion dev = new frmDevolucion(DevSelec);
                dev.ShowDialog();
            }
        }
        ...
        private void btn_nuevo_Click(object sender, EventArgs e)
        {
            ...
            frmDevolucion dev = new frmDevolucion();
            dev.ShowDialog();
        }
        ...
        private void btn_buscar_Click(object sender, EventArgs e)
        {
            ...
            op.ejecutar(dgv_dev, "devolucion_venta");
        }
        ...
        private void dgv_dev_CellClick(object sender, DataGridViewCellEventArgs e)
        {
            if (dgv_dev.SelectedRows.Count == 1)
            {
                int id = Convert.ToInt16(dgv_dev.CurrentRow.Cells[0].Value);
