...
namespace FuncionesNavegador
{
    public class CapaNegocio
    {
        ...
        public ComboBox llenarCbo(string Query, string tabla, ComboBox cbo, string valor, string mostrar)
        {
            ...
            String Query1 = Query;
            OdbcDataAdapter dad = new OdbcDataAdapter(Query1, seguridad.Conexion.ObtenerConexionODBC());
        ...
        public void ActualizarGrid(DataGridView dg, String Query, string tabla)
        {
            ...
            OdbcDataAdapter MiDataAdapter = new OdbcDataAdapter(Query, seguridad.Conexion.ObtenerConexionODBC());
            //LLenar el DataSet
