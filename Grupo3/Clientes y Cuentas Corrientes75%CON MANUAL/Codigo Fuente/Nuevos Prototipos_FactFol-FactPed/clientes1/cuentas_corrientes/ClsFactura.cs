...
namespace cuentas_corrientes
{
    public class ClsFactura
    {
        ...
        public ClsFactura(int codfact, int codemp, string seri, int codven, int concte, int codimp, string fecven, string fecemi, string efact, string est, decimal subt, decimal tot )
