...
namespace cuentas_corrientes
{
    public partial class frmdeuda : Form
    {
        ...
        public void mostrar()
        {
            OdbcCommand _comando = new OdbcCommand(String.Format("SELECT serie from factura "), seguridad.Conexion.ObtenerConexionODBC());
            ...
            try
            {
                ...
                else
                {
                 ...
                 "SELECT id_cliente_pk FROM cliente where nombre ='{0}' ", cbo_cliente.Text), seguridad.Conexion.ObtenerConexionODBC());
                    ...
                    OdbcCommand _comando2 = new OdbcCommand(String.Format(
                 "SELECT id_empresa_pk FROM empresa where tipo ='{0}' ", cbo_empresa.Text), seguridad.Conexion.ObtenerConexionODBC());
                    OdbcDataReader _reader2 = _comando2.ExecuteReader();
                    while (_reader2.Read())
                    {
