...
namespace cuentas_corrientes
{
    public partial class frmListadoPrecio : Form
    {
        ...
        public void llenar_encabezado()
        {
            ...
            string scad = "SELECT * FROM precio INNER JOIN bien ON bien.id_bien_pk = precio.id_bien_pk and precio.id_tprecio_pk= "+cod.codtipo;
            ...
            while (mdr.Read())
            {
                ...
                dgv_bien.Rows.Add(mdr.GetString(15), mdr.GetDecimal(14), mdr.GetDecimal(1));
