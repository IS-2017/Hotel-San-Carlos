...
namespace ModuloAdminHotel
{
    class capadenegocioe
    {
        ...
        {
            capadatose.Siguiente(datagridview);
        }
        #endregion
        ...
        {
            capadatose.Anterior(datagridview);
        }
        #endregion
        ...
        {
            capadatose.Ultimo(datagridview);
        }
        #endregion
        ...
        {
            capadatose.Primero(datagridview);
        }
        #endregion
        ...
        public void ActualizarGrid(DataGridView dg, String Query, string tabla)
        {
            ...
            /*  conexionmanipulacion con = new conexionmanipulacion();
             ...
             // MySqlDataAdapter MiDataAdapter = new MySqlDataAdapter(Query, con.Conectar());
