...
namespace ModuloAdminHotel
{
    public partial class Frm_ReservacionHotel : Form
    {
        ...
        private void btn_eliminar_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                if (resultado == DialogResult.Yes)
                {
                    ...
                    fn.ActualizarGrid(datagridantes, "select * from reservacion_habitacion where estado = Reservado", "reservacion_habitacion");
                }
            }
            catch
            {
        ...
        private void btn_siguiente_Click(object sender, EventArgs e)
        {
            ...
            {
                MessageBox.Show("La reservacion se encuentra inactiva");
            }
        }
