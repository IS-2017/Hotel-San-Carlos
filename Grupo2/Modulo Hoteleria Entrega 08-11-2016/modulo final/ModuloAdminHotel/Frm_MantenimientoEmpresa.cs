        ...
        private void btn_guardar_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                if (editar)
                {
                    ...
                    bita.Modificar("Se modifico el registro", "empresa");

                }
                else
                {
                    fn.insertar(datos, tabla);
                    bita.Insertar("Se inserto el registro", "empresa");
                }
                fn.LimpiarComponentes(this);
...
//                String codigo2 = this.dataGridView1.CurrentRow.Cells[0].Value.ToString();
                ...
                if (resultado == DialogResult.Yes)
                {
                    ...
                    bita.Eliminar("Se elimino el registro", "empresa");
                }
            }
            catch
            {
