...
namespace ModuloAdminHotel
{
    public partial class Frm_MantenimientoHabitaciones : Form
    {
        ...
        private void btn_guardar_Click(object sender, EventArgs e)
        {
            ...
            txt_tipo.Text = cbo_tipo.SelectedValue.ToString();
            ...
            else
            {
                ...
                if (editar)
                {
                    ...
                    bita.Modificar("Se modifico el registro", "habitacion");

                }
                else
                {
                    fn.insertar(datos, tabla);
                    bita.Modificar("Se inserto el registro", "habitacion");
                }
                fn.LimpiarComponentes(this);
        ...
        private void btn_eliminar_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                if (resultado == DialogResult.Yes)
                {
                    ...
                    bita.Eliminar("Se elimino el registro", "habitacion");
                }
            }
            catch
            {
