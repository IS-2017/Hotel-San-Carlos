...
namespace ModuloAdminHotel
{
    public partial class Frm_MantemientoTipoHabitacion : Form
    {
        ...
        private void btn_guardar_Click(object sender, EventArgs e)
        {
            ...
            {
                string tabla = "tipo_habitacion";
                if (editar)
                {
                    fn.modificar(datos, tabla, atributo, codigo);
                    bita.Modificar("Se modifico el registro", "tipo_habitacion");

                }
                else
                {
                    fn.insertar(datos, tabla);
                    bita.Insertar("Se inserto el registro", "tipo_habitacion");
                }
                fn.LimpiarComponentes(this);
                fn.ActualizarGrid(datagridantes, "select * from tipo_habitacion", tabla);
        ...
        private void btn_eliminar_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                if (resultado == DialogResult.Yes)
                {
                    ...
                    bita.Eliminar("Se elimino el registro", "tipo_habitacion");
                }
            }
            catch
            {
        ...
        private void txt_ninio_TextChanged(object sender, EventArgs e)
        {
