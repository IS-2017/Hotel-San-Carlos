...
namespace ModuloAdminHotel
{
    public partial class Frm_Promocion : Form
    {
        ...
        private void btn_guardar_Click(object sender, EventArgs e)
        {
            ...
            txt_salon.Text = cbo_salon.SelectedValue.ToString();
            txt_habitacion.Text = cbo_habitacion.SelectedValue.ToString();
            txt_bien.Text = cbo_bien.SelectedValue.ToString();
            txt_categoria.Text = cbo_bien.SelectedValue.ToString();
            ...
            else
            {
                ...
                if (editar)
                {
                    ...
                    bita.Modificar("Se modifico el registro", tabla);
