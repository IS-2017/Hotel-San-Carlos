...
namespace ModuloAdminHotel
{
    public partial class Frm_Promocion : Form
    {
        ...
        private void Frm_Promocion_Load(object sender, EventArgs e)
        {
            ...
            MySqlDataAdapter dad2 = new MySqlDataAdapter(Query2, con.rutaconectada());
            ...
            MySqlDataAdapter dad3 = new MySqlDataAdapter(Query3, con.rutaconectada());
            dad3.Fill(ds3, "bien");
            ...
            MySqlDataAdapter dad4 = new MySqlDataAdapter(Query4, con.rutaconectada());
