...
namespace dllconsultasgeneraless
{
    public partial class frm_consultas : Form
    {
        ...
        {
            //Agregar un nuevo campo de busqueda 
        ...
        {
           //agregar una condicion mas a la consulta del query
        ...
        {
            //agrega una concion "O" si algun otro campo es igual o mayor, etc.. tambien se ejecutara la busqueda 
            if (rdb_cond1.Checked == true)
            {
                if (cbo_condicion1.Text == "" || cbo_condicion2.Text == "" || cbo_condicion3.Text == "")
                {
        ...
        {
            // ---------------------------------------------QUERYS SIN WHERE---------------------------------------------------
            // aqui se realiza la construccion del Query sin where
        ...
        {
           //cambia a desabilitado todos los campos en el form
            cbo_from2.Enabled = false;
            cbo_select2.Enabled = false;
            cbo_from3.Enabled = false;
            cbo_select3.Enabled = false;
        ...
        //llama a la ayuda para el usuario
        private const string ayudacinetopiaadministrativa = "consulta general.chm";
        private void btn_ayuda_Click(object sender, EventArgs e)
        {
            System.Windows.Forms.Help.ShowHelp(this, Application.StartupPath + @"/" + ayudacinetopiaadministrativa);
        }

        private void lbl_vistapreviaconsulta_Click(object sender, EventArgs e)
        {
